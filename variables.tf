...
variable "azs" { type = number default = 2 }
variable "ami" { type = string default = "ami-0ecb62995f68bb549" }
variable "instance_type" { type = string default = "t3.micro" }
variable "key_name" { type = string default = "ansible-key" }
variable "ssh_cidr" { type = string default = "0.0.0.0/0" }
variable "nat" { type = bool default = true }
variable "ebs_size" { type = number default = 8 }
...
variable "enable_http" { type = bool default = true }
variable "enable_https" { type = bool default = true }
variable "enable_jenkins" { type = bool default = true }
